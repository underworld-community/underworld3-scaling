...
if scaling_type == 1:
    ...
    outputPath = "../../../../../scratch/el06/jg0883/uw3-scaling/output/timing-swarm-petsc-save-chkpt-2D-weak/"
elif scaling_type == 2:
    outputPath = "../../../../../scratch/el06/jg0883/uw3-scaling/output/timing-swarm-petsc-save-chkpt-2D-strong/"
...
if uw.mpi.rank == 0 and debug:
    print("1. Attempting save swarm using petsc_save_checkpoint ... ")
swarm.petsc_save_checkpoint('swarm', 0, outputPath + f"timing_els_{n_els}")
if uw.mpi.rank == 0 and debug:
    print("1. Saved swarm using petsc_save_checkpoint ... ")
