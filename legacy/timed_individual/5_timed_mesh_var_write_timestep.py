...
with mesh.access(v_soln, p_soln, t_soln):
    v_soln.data[...] = 0
    p_soln.data[...] = 0
    t_soln.data[...] = 0
...
if scaling_type == 1:
    ...
    outputPath = "../../../../../scratch/el06/jg0883/uw3-scaling/output/timing-mesh-var-write-timestep-2D-weak/"
elif scaling_type == 2:
    #outputPath = "/scratch/el06/jg0883/uw3-scaling/output/timing-mesh-petsc_save_checkpoint-2D-strong/"
    outputPath = "../../../../../scratch/el06/jg0883/uw3-scaling/output/timing-mesh-var-write-timestep-2D-strong/"
...
if uw.mpi.rank == 0 and debug:
    print("1. Attempting save mesh variable using write_timestep ... ")
mesh.write_timestep(f"timing_els_{n_els}",
                    index = 0,
                    meshUpdates = False,
                    meshVars=[v_soln],  # only save one variable for tests
                    outputPath = outputPath)
if uw.mpi.rank == 0 and debug:
    print("1. Saved mesh variable using write_timestep ... ")
