...
if uw.mpi.rank == 0 and debug:
    print("1. Attempting creation of UnstructuredSimplexBox ... ")
...
if uw.mpi.rank == 0 and debug:
    print("1. Done creation of UnstructuredSimplexBox ... ")

if scaling_type == 1:
    outputPath = "/scratch/el06/jg0883/uw3-scaling/output/timing-unstructured-simplex-box-2D-weak/"
    #outputPath = "../../../../../scratch/el06/jg0883/uw3-scaling/output/timing-unstructured-simplex-box-2D-weak/"
elif scaling_type == 2:
    outputPath = "/scratch/el06/jg0883/uw3-scaling/output/timing-unstructured-simplex-box-2D-strong/"
    #outputPath = "../../../../../scratch/el06/jg0883/uw3-scaling/output/timing-unstructured-simplex-box-2D-strong/"
