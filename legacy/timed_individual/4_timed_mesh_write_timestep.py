...
if scaling_type == 1:
    ...
    outputPath = "../../../../../scratch/el06/jg0883/uw3-scaling/output/timing-mesh-write-timestep-2D-weak/"
elif scaling_type == 2:
    #outputPath = "/scratch/el06/jg0883/uw3-scaling/output/timing-mesh-petsc_save_checkpoint-2D-strong/"
    outputPath = "../../../../../scratch/el06/jg0883/uw3-scaling/output/timing-mesh-write-timestep-2D-strong/"
...
if uw.mpi.rank == 0 and debug:
    print("1. Attempting save mesh using write_timestep ... ")
...
if uw.mpi.rank == 0 and debug:
    print("1. Saved mesh using write_timestep ... ")
